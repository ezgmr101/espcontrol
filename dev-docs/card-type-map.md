...
| `cover` | Cover | `src/webserver/types/slider.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_sliders.h` | `cover` | Yes | Type: modal, default, tilt, toggle, open, close, stop, set_position; Position | Visible | Contract, Codec, Parser, HA, Backup |
